    ...
    <main className={styles.wrap}>
      ...
      {isEditing && editable && (
        <div style={{ padding: 16 }}>
          <label>
            Receipt Number
            <input value={editable.receiptNumber || ""} onChange={(e) => setEditable({ ...editable, receiptNumber: e.target.value })} />
          </label>

          <label>
            Amount
            <input type="number" value={editable.amount || 0} onChange={(e) => setEditable({ ...editable, amount: Number(e.target.value) })} />
          </label>

          <label>
            Issued At
            <input type="date" value={editable.issuedAt ? String(editable.issuedAt).split("T")[0] : ""} onChange={(e) => setEditable({ ...editable, issuedAt: e.target.value })} />
          </label>
