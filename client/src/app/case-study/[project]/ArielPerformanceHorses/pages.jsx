export const pages = [
  {
    url: "/ArielPerformance/Options/Fonts.png",
    description: "Fonts that matches the logo",
  },
  {
    url: "/ArielPerformance/Options/Navbar.png",
    description: "Colours and navbar options",
  },
];
...
export const mockupPages = [
  {
    url: "/ArielPerformance/StartingMocks/HomeV.png",
    description:
      "Initial mockup of the home page, which was later revised to better align with the client's vision and branding.",
  },
  {
    url: "/ArielPerformance/StartingMocks/Services.png",
    description:
      "Initial mockup of the services page, which was later revised to better align with the client's vision and branding.",
  },
  {
    url: "/ArielPerformance/StartingMocks/Contact.png",
    description:
      "Initial mockup of the contact page, which was later revised to better align with the client's vision and branding.",
  },
  {
    url: "/ArielPerformance/StartingMocks/ServicesFullPage.png",
    description:
      "Initial mockup of the services page, which was later revised to better align with the client's vision and branding.",
  },
];
