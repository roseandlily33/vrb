export const projects = [
  {
    ...
    description:
      "Comprehensive training platform with payments, course management, and automated certifications.",
  ...
  },
  {
    ...
    description:
      "Modern portfolio site showcasing responsive design and front-end development with Next.js.",
    tech: ["Design", "Next.js"],
