...
export const extrasList = [
    ...
    // {
    //     title: "CI/CD Setup",
    //     description: "Automate your deployment process for faster, safer updates.",
    //     // What you do: Set up continuous integration and deployment pipelines.
    //     // Includes: GitHub Actions, automated builds, deployment to hosting.
    // },
    // {
